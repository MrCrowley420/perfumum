    ...
    leerLocalStorage() {
        ...
        productosLS.forEach(function(producto) {
            ...
            row.innerHTML = `
                ...
                <td>${producto.precio}</td>
                <td>
                    <a href="#" class="borrar-producto fa fa-window-close" data-id="${producto.id}"></a>
                </td>
            `;
            listaProductos.appendChild(row);
        });
    ...
    leerLocalStorageCompra() {
        ...
        productosLS.forEach(function(producto) {
            ...
            row.innerHTML = `
                ...
                <td>
                    <a href="#" class="borrar-producto fa fa-window-close" style="font-size:30px" data-id="${producto.id}"></a>
                </td>
            `;
